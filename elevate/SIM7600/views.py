...
# Format the datetime object into the desired string format
            ...
            logs_for_selected_date = AllLogs.objects.filter(datetime__date=date_obj)
             # Serialize the logs data
            serialized_logs = [{
                'name': log.name,
                'slot_no': log.slot_no,
            ...
            name=name.lower()
            print(name)
            logs = AllLogs.objects.filter(name=name)
